...
const SignupPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!homeLocation) {
      return setError('Please select your home apartment');
    }
    
    try {
      setError('');
      setLoading(true);
      await signupWithEmail(email, password, name, homeLocation);
      navigate('/');
    } catch (error) {
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      // The AuthContext will detect if this is a new user and redirect accordingly
      // We'll need to handle collecting additional info in a separate component/flow
